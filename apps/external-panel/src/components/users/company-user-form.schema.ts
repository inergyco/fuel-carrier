import { createExternalCompanyUserDtoSchema } from '@fuel-carrier/shared-validation/company-user/create'
import { strongPasswordSchema } from '@fuel-carrier/shared-validation/password'
import { z } from 'zod'

export const companyUserCreateFormSchema = createExternalCompanyUserDtoSchema
