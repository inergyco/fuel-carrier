...
const en: BaseTranslation = {
  ...
  internalPanel: {
    ...
    map: {
      ...
      clickVehicleHint: 'Tap History route, then open a vehicle and choose a time range.',
      chooseTimeRange: 'History route',
      ...
      trajectoryHint: 'Use History route to pick a vehicle and time range, then return to the live fleet map.',
