  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <input
        ref={ref}
        className={cn(
          'input input-sm h-10 w-full rounded-lg border bg-base-100/60 px-3 text-sm tracking-wide placeholder:text-base-content/20 focus:outline-none focus:ring-1',
          error
