...
export function dataTableEditActionClassName(...inputs: ClassValue[]) {
  return cn(
    'inline-flex size-11 min-h-11 min-w-11 shrink-0 items-center justify-center border border-primary/25 bg-primary/10 p-0 text-primary hover:border-primary/35 hover:bg-primary/15',
    ...inputs,
  )
}
...
export function dataTableDeleteActionClassName(...inputs: ClassValue[]) {
  return cn(
    'inline-flex size-11 min-h-11 min-w-11 shrink-0 items-center justify-center border border-error/30 bg-error/10 p-0 text-error hover:border-error/40 hover:bg-error/15',
    ...inputs,
  )
}
...
export function dataTableViewActionClassName(...inputs: ClassValue[]) {
  return cn(
    'btn btn-ghost btn-sm inline-flex size-11 min-h-11 min-w-11 shrink-0 items-center justify-center border border-base-content/12 bg-base-100/45 p-0 normal-case tracking-normal transition-all hover:border-base-content/20 hover:bg-base-100/65',
    ...inputs,
  )
}
